...
Простое приложение интернет‑магазина: список товаров, их карточки, корзина и оформление заказов. Сделано на Spring Boot, чтобы быстро показать базовый поток покупки.
